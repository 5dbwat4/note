...
示波器显示的测量结果如下图所示，请计算二极管的导通电压（5分）。
...
将三棱镜安放在载物平台上，三棱镜顶角对准平行光管的中心，使平行光分成两半，在AB和AC面上反射出去，并且三棱镜顶角应接近平台中心偏上一点点位置，否则望远镜中会看不到反射光。测量左右两反射光线的角位置，就可算得棱镜顶角大小。每次测量时稍微改变三棱镜顶角接近平台中心的位置。
