...
<Card type="example" title="Example">
	...
	![](./assets/Pasted image 20250428101521.png)
...
- 选择操作在以下两个条件下对 Theta 连接操作可以分配（Distribute）
	...
	![](./assets/Pasted image 20250428103233.png)
...
![](./assets/Pasted image 20250428110309.png)
...
- 如果 $R\cap S$ 是 $R$ 的一个主键，那么 $s$ 的一个元组最多会跟 $r$ 的一个元组连接
	...
	![](./assets/Pasted image 20250428192732.png)
	
- 如果 $R\cap S$ 在 $S$ 中是 $S$ 引用 $R$ 的外键，那么 $r\Join s$ 中元组的数量和 $s$ 中的元组数量相同
	
	![](./assets/Pasted image 20250428193039.png)
...
<Card type="note" title="Pseudo Code">

	![](./assets/Pasted image 20250428204437.png)

	![](./assets/Pasted image 20250428204449.png)
</Card>
***
...
![](./assets/Pasted image 20250428204542.png)
***
...
![](./assets/Pasted image 20250428221442.png)
***
...
<Card type="question" title="为什么我们在 sum 中还需要维护一个 count，而不是直接检测 sum=0 的情况？">
