...
# comments: true
--- 
import Card from "@md-comp/card.vue"

# Chapter 06 : Entity-Relationship Model

<Card type="abstract" title="Abstract">
...
![](./assets/Pasted image 20250324100511.png)
***
### Design Phases
...
<Card type="example" title="E-R Diagram for a University Enterprise">

	![](./assets/Pasted image 20250324101514.png)
...
![](./assets/Pasted image 20250324105605.png)
***
### Relationship Sets

- 关系是多个实体之间的关联

![](./assets/Pasted image 20250324105742.png)
...
![](./assets/Pasted image 20250324110047.png)
***
#### Relationship Sets with Attributes

关系集也可以拥有属性，例如，实体集 instructor 和 student 之间的 advisor 关系集可能具有属性 date，该属性跟踪 student 开始与 advisor 关联的时间：

![](./assets/Pasted image 20250324111016.png)

![](./assets/Pasted image 20250324111033.png)
***
#### Roles
...
![](./assets/Pasted image 20250324111225.png)
***
...
![](./assets/Pasted image 20250324111658.png)
***
### Attributes
...
![](./assets/Pasted image 20250324113001.png)
***
...
<Card type="example" title="Example">
...
=== "一对一关系"
	...
	![](./assets/Pasted image 20250324113448.png)
...
=== "一对多关系"
	...
	![](./assets/Pasted image 20250324113620.png)
...
=== "多对一关系"
	...
	![](./assets/Pasted image 20250324113654.png)
...
=== "多对多关系"
	...
	![](./assets/Pasted image 20250324113722.png)
</Card>
***
...
- 完全参与（Total Participation）通常使用双线表示，表示实体集中的每个实体都至少参与关系集中的一个关系
	...
	![](./assets/Pasted image 20250324115011.png)
...
- 为了区分关系集的各种关系，我们使用关系集中实体的各个主键
	...
	![](./assets/Pasted image 20250324210940.png)
...
<Card type="example" title="Example">
	...
	![](./assets/Pasted image 20250324213001.png)
...
![](./assets/Pasted image 20250324214624.png)
***
...
![](./assets/Pasted image 20250324215646.png)
***
...
![](./assets/Pasted image 20250324220019.png)
***
...
![](./assets/Pasted image 20250324220316.png)
...
![](./assets/Pasted image 20250324231752.png)
***
## Design Issues

### Common Mistakes in E-R Diagrams

<Card type="example" title="Examples">

=== "信息冗余"

	![](./assets/Pasted image 20250324231856.png)
	
	student 的 `dept_name` 应该去掉

=== "关系属性使用不当"

	![](./assets/Pasted image 20250324231945.png)
	
	这里一门课可能有很多次作业，不能只用一个实体
	
	解决方法：
	
	![](./assets/Pasted image 20250324232032.png)
</Card>
***
### Use of Entity Sets V.S. Attributes

![](./assets/Pasted image 20250324232222.png)
...
![](./assets/Pasted image 20250324232422.png)
...
![](./assets/Pasted image 20250324232509.png)
...
![](./assets/Pasted image 20250324233409.png)
...
![](./assets/Pasted image 20250324234732.png)
***
