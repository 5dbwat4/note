...
![](./assets/Pasted image 20250407100719.png)

如果我们想合并 instructor 和 department 呢？我们会得到如下信息：

![](./assets/Pasted image 20250407100807.png)
...
=== "Lossy Decomposition"
	...
	![](./assets/Pasted image 20250407101758.png)
	
	可以看到，分解过后的结果自然连接得到了非常多冗余甚至是错误的信息

=== "Lossless-Join Decomposition"

	![](./assets/Pasted image 20250407101918.png)
</Card>
...
![](./assets/Pasted image 20250407120726.png)
***
...
![](./assets/Pasted image 20250407120645.png)
...
<Card type="note" title="Extraneous Attributes">
...
![](./assets/Pasted image 20250407120739.png)
...
![](./assets/Pasted image 20250407133225.png)
...
??? note "Answer"
	...
	![](./assets/Pasted image 20250407134537.png)
...
![](./assets/Pasted image 20250407143154.png)
...
![](./assets/Pasted image 20250407144959.png)
